...
daytoday.report = function report_daytoday(datastorage,sorteddaystoshow,options) {
  ...
  d3.select('body').append('svg')
    ...
    var tstActiveTreatment = profile.getCurrentProfile(tstTimeAfterMidnight, datastorage.profiles[2].store[0]);
    console.log("Test Active Treat: ", tstActiveTreatment);
    var tstGTB = profile.getTempBasal(date, datastorage.profiles[2].store[0]);
